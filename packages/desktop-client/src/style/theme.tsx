...
import * as contrastTheme from './themes/contrast';
import * as darkTheme from './themes/dark';
import * as developmentTheme from './themes/development';
import * as funkyTheme from './themes/funky';
import * as lightTheme from './themes/light';
import * as midnightTheme from './themes/midnight';
import * as protanopiaTheme from './themes/protanopia';
import * as tritanopesTheme from './themes/tritanopes';

const themes = {
  light: { name: 'Light', colors: lightTheme },
  dark: { name: 'Dark', colors: darkTheme },
  midnight: { name: 'Midnight', colors: midnightTheme },
  contrast: { name: 'High Contrast', colors: contrastTheme },
  funky: { name: 'Funky', colors: funkyTheme },
  protanopia: { name: 'Protanopia', colors: protanopiaTheme },
  tritanopes: { name: 'Tritanopes', colors: tritanopesTheme },
