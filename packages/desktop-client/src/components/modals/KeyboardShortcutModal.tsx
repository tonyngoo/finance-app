        ...
        <>
          ...
          >
            <View>
              ...
              <Shortcut
                shortcut="1"
                description={t('Move to budget page')}
                meta={ctrl}
              />
              <Shortcut
                shortcut="2"
                description={t('Move to reports page')}
                meta={ctrl}
              />
              <Shortcut
                shortcut="3"
                description={t('Move to schedules page')}
                meta={ctrl}
              />
              <Shortcut
                shortcut="4"
                description={t('Move to payees page')}
                meta={ctrl}
              />
              <Shortcut
                shortcut="5"
                description={t('Move to rules page')}
                meta={ctrl}
              />
              <Shortcut
                shortcut="6"
                description={t('Move to all accounts page')}
                meta={ctrl}
              />
              <Shortcut
                shortcut="0"
                description={t('Move to settings page')}
                meta={ctrl}
              />
              {onBudget && (
                <Shortcut
              ...
              {onAccounts && (
                <>
                  ...
                  <Shortcut
                    shortcut="V"
                    description={t('Copy the selected transaction(s)')}
                  />
                  <Shortcut
                    shortcut="D"
